...
CreerElecteur::CreerElecteur(QWidget *parent)
: QDialog(parent)
{
...
void CreerElecteur::initialiserBannieres()
{
...
void CreerElecteur::initialiserZonesDeSaisie()
{
...
void CreerElecteur::actualiserBoutons()
{
	switch(modeCourant) {
	case EnCours:
...
void CreerElecteur::actualiserSaisies()
{
	// TODO Implémenter
...
bool CreerElecteur::laSaisiePrenomEstValide()
{
	QString texte = prenomSaisie->text();
	return util::estUnNom(texte.toStdString());
}

bool CreerElecteur::laSaisieNasEstValide()
{
	QString texte = nasSaisie->text();
	return util::validerNas(texte.toStdString());
}

bool CreerElecteur::laSaisieDateEstValide()
{
	// TODO validation à implémenter
	return true;
}

bool  CreerElecteur::laSaisieAdresseEstValide()
{
...
bool CreerElecteur::lesSaisiesSontToutesValides()
{
...
void CreerElecteur::actualiser(Mode mode)
{
	modeCourant = mode;
	actualiserBoutons();
	actualiserSaisies();
...
void CreerElecteur::clicBoutonSoumettre()
{
    // TODO implémenter. Appelle le constructeur de l'objet Électeur avec les champs du formulaire.
	// TODO retourne cet objet au caller.
...
void CreerElecteur::clicBoutonReInitialiser()
{
...
void CreerElecteur::formulaireModifie()
{
	actualiser( lesSaisiesSontToutesValides() ? Pret : EnCours );
}

elections::Electeur* CreerElecteur::reqElecteur()
{
	return electeur;
}
